...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">测评标准管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>测评标准列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">测评标准列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var zhaiyaoCell  = document.createElement('td');

						  if(item.zhaiyao != null && item.zhaiyao != "" && item.zhaiyao.length >= 11){
			  	zhaiyaoCell.innerHTML = item.zhaiyao.substring(0, 10) + "..."; 
			  }else{
			  	zhaiyaoCell.innerHTML = item.zhaiyao;
			  }


			row.appendChild(zhaiyaoCell);
			...
			var xiangguanfujianCell  = document.createElement('td');

						  var xiangguanfujianFile = document.createElement('button');
			  xiangguanfujianFile.setAttribute('class','btn-table')
			  xiangguanfujianFile.innerHTML = '下载';
			  var xiangguanfujianFileAttr = "download('" + item.xiangguanfujian + "')"
			  xiangguanfujianFile.setAttribute('onclick',xiangguanfujianFileAttr);
        	          xiangguanfujianCell.appendChild(xiangguanfujianFile);


			row.appendChild(xiangguanfujianCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("cepingbiaozhun/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"cepingbiaozhun");
