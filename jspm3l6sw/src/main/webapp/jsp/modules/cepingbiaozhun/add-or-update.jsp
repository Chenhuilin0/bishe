...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑测评标准</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>测评标准管理</span></li>
								<li class="breadcrumb-item active"><span>编辑测评标准</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">测评标准信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>摘要</label>
										<textarea name="zhaiyao" class="form-control" id="zhaiyao" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>图片</label>
									...
									<div class="form-group col-md-6">
										<label>相关附件</label>
										<div>
										<div class="upload">选择文件<input name="file" type="file" class="form-control-file" id="xiangguanfujianupload"></div>
										<label id="xiangguanfujianFileName"></label>
										<input name="xiangguanfujian" id="xiangguanfujian-input" type="hidden">
										</div>
									</div>
									<div class="form-group col-md-6">
										<label>内容</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "cepingbiaozhun/info/" + id,
		...
		function upload(){
			...
			$('#xiangguanfujianupload').fileupload({
				url: baseUrl + 'file/upload',
				headers:{ token: window.sessionStorage.getItem("token")},
				dataType: 'json',
				done: function (e, data) {							
					document.getElementById('xiangguanfujian-input').setAttribute('value',baseUrl+'file/download?fileName='+data.result.file);
					if(document.getElementById('xiangguanfujianFileName') != null){
						document.getElementById('xiangguanfujianFileName').innerHTML = "上传成功!";
					}		
					$("#xiangguanfujianImg").attr("src",data.result.file);												
				}
			});
		}  
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("cepingbiaozhun/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("cepingbiaozhun/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("cepingbiaozhun"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#zhaiyao").val(ruleForm.zhaiyao);
			$("#tupian-input").val(ruleForm.tupian);
			$("#xiangguanfujian-input").val(ruleForm.xiangguanfujian);
			$("#xiangguanfujianFileName").html(ruleForm.xiangguanfujian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.zhaiyao != null && res.data.zhaiyao != ''){

					$("#zhaiyao").val(res.data.zhaiyao);
					}
					...
					if(res.data != null && res.data != '' && res.data.xiangguanfujian != null && res.data.xiangguanfujian != ''){

					$("#xiangguanfujian-input").val(res.data.xiangguanfujian);
					$('#xiangguanfujianFileName').val(res.data.xiangguanfujian)
					}
