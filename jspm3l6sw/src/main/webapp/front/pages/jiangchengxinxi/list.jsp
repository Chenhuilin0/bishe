    ...
    <fieldset class="search-container" style="text-align: center;margin: 50px 0;">
      <form class="layui-form" style="margin: 10px 0;">
        ...
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" name="jiangchengleixing" id="jiangchengleixing" placeholder="奖惩类型" autocomplete="off" class="layui-input">
          </div>
        </div>   
        <div class="layui-inline" style="margin-left: 30px;">
          ...
          <button v-if="isAuth('jiangchengxinxi','新增')" @click="jump('../jiangchengxinxi/add.jsp')" type="button" class="layui-btn btn-theme">
      ...
      <div class="box">
        <ul class="clearfix">
          <li v-for="(item,index) in dataList" v-bind:key="index">
            <a :href="'../jiangchengxinxi/detail.jsp?id='+item.id">
              <figure>
              </figure>
              <div class="div1">
                <b></b>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#jiangchengleixing').val()) {
          param['jiangchengleixing'] = jquery('#jiangchengleixing').val() ? '%' + jquery('#jiangchengleixing').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('jiangchengxinxi/list', 'get', param, function(res) {
