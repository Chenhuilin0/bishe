				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="jiangchengleixing" id="jiangchengleixing">
									<option value="">请选择</option>
									<option v-for="(item,index) in jiangchengleixing" v-bind:key="index" :value="item">{{item}}</option>
								</select>
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="neirong" id="neirong" placeholder="内容" autocomplete="off" class="layui-input">
							</div>
						</div>
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																								...
                																								vue.jiangchengleixing = '奖励,惩罚'.split(',')
