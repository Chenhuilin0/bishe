				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="xuekechengji" id="xuekechengji" placeholder="学科成绩" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">活动表现</label>
							<div class="layui-input-block">
								<input type="text" name="huodongbiaoxian" id="huodongbiaoxian" placeholder="活动表现" autocomplete="off" class="layui-input">
							</div>
						</div>
