		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.banjirenshu" type="text" name="banjirenshu" id="banjirenshu" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">班主任：</label>
						<div class="layui-input-block">
							<input v-model="detail.banzhuren" type="text" name="banzhuren" id="banzhuren" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
