    ...
    <fieldset class="search-container" style="text-align: center;margin: 50px 0;">
      <form class="layui-form" style="margin: 10px 0;">
        ...
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" name="banzhuren" id="banzhuren" placeholder="班主任" autocomplete="off" class="layui-input">
          </div>
        </div>   
      ...
      <div class="box">
        <ul class="clearfix">
          <li v-for="(item,index) in dataList" v-bind:key="index">
            <a :href="'../banjixinxi/detail.jsp?id='+item.id">
              <figure>
              </figure>
              <div class="div1">
                <b></b>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#banzhuren').val()) {
          param['banzhuren'] = jquery('#banzhuren').val() ? '%' + jquery('#banzhuren').val() + '%' : '';
        }  
        // 获取列表数据
