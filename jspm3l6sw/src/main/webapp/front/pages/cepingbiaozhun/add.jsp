			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-inline" style="line-height: 50px;">
							<input type="hidden" :value="detail.xiangguanfujian" id="xiangguanfujian" name="xiangguanfujian" />
                            <button type="button" class="layui-btn btn-theme" id="xiangguanfujianUpload">
								<i class="layui-icon">&#xe67c;</i>上传相关附件
							</button>
							<a download="相关附件" :href="detail.xiangguanfujian">点击下载相关附件</a>
						</div>
					</div>
                                                                                                                                            <div class="layui-form-item" pane>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				var tupianUpload = upload.render({
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
												                ...
												                var xiangguanfujianUpload = upload.render({
					//绑定元素
					elem: '#xiangguanfujianUpload',
					//上传接口
					url: http.baseurl + 'file/upload',
					// 请求头
					headers: {
					...
					// 上传成功
						...
						if (res.code == 0) {
							...
							var url = http.baseurl + 'upload/' + res.file;
							jquery('#xiangguanfujian').val(url);
                            vue.detail.xiangguanfujian = url;
						} else {
							layer.msg(res.msg, {
								time: 2000,
								icon: 5
				...
				form.on('submit(*)', function(data) {
					...
					// 提交数据
					http.requestJson('cepingbiaozhun' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
