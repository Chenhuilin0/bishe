				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('xuesheng','学生成绩')" @click="onAcrossTap('xueshengchengji')" type="button" class="layui-btn">
								学生成绩
							</button>
																					<button v-if="isAuth('xuesheng','奖惩信息')" @click="onAcrossTap('jiangchengxinxi')" type="button" class="layui-btn">
								奖惩信息
							</button>
																					<button v-if="isAuth('xuesheng','活动记录')" @click="onAcrossTap('huodongjilu')" type="button" class="layui-btn">
								活动记录
							</button>
																					<button v-if="isAuth('xuesheng','学生综合测评成绩')" @click="onAcrossTap('xueshengzonghecepingchengji')" type="button" class="layui-btn">
								学生综合测评成绩
							</button>
