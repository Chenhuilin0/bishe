						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="xueshengxingming" id="xueshengxingming" placeholder="学生姓名" autocomplete="off" class="layui-input">
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">实践活动</label>
							<div class="layui-input-block">
								<input type="text" name="shijianhuodong" id="shijianhuodong" placeholder="实践活动" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">创新活动</label>
							<div class="layui-input-block">
								<input type="text" name="chuangxinhuodong" id="chuangxinhuodong" placeholder="创新活动" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">在校表现情况</label>
							<div class="layui-input-block">
								<input type="text" name="zaixiaobiaoxianqingkuang" id="zaixiaobiaoxianqingkuang" placeholder="在校表现情况" autocomplete="off" class="layui-input">
							</div>
						</div>
