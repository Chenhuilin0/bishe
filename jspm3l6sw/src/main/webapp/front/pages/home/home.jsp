...
<body>
    ...
    <div class="about-culture-box">
      <div class="about-culture">
        ...
        <div class="about-culture-piclist">
          <ul>
            <li v-for="(item,index) in cepingbiaozhunList" v-bind:key="index" @click="jump('../cepingbiaozhun/detail.jsp?id='+item.id)">
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`cepingbiaozhun/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.cepingbiaozhunList = res.data.list;
      });
    });
  </script>
</body>
